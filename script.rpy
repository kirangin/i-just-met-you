...
define pr = Character("Penumpang")
define t  = Character("Tetangga")
define d  = Character("Dokter")
...
label bad_end:
  "Dia bertanya hanya untuk menunjukan rasa sopan santun karena kita duduk berhadapan"
  "Jadi, ada baiknya aku tidak mengganggu dia dengan isi otakku ini"
  "Lagian, apa yang bisa aku bicarakan?"
  "Skill komunikasiku sangat buruk, aku bahkan hanya memiliki beberapa teman"
  "Dan beberapa teman itu bisa dihitung dengan jari tangan kananku"
  "Mungkin bukan teman"
  "Sahabat!"
  "Itulah kata yang tepat untuk mereka, karena mereka sangat berarti bagiku"
  ...
  "Sial..." 
  "Jangan-jangan dia ingin menanyakan sesuatu lagi?"
  "Jika itu sampai terjadi, lebih baik aku pura-pura tidak biisa mendengarnya"

  p "Kalau boleh tahu, boleh tidak tahu namamu?"
  a "Huh?"

  "Huh?"
  "Dia ngomong apaan?"
  "‘Kalau boleh tahu, boleh tidak tahu namamu?’"
  "Huh?"

  p "M-maksud aku, boleh tidak, tahu namamu?"

  "Aku memasang wajah tololku disana"
  "Setelah dia membenarkan kalimatnya pun aku tetap tidak mengerti apa yang dia maksud..."

  p "A-ahaha... lupain aja... maaf..."
  a "Y-ya..."

  "Kami pun tidak melontarkan satu kata pun kedepannya"
  "Hanya karena sebuah miss-komunikasi..."
  ...
  "Tiba-tiba bikin penumpang stress gara-gara baru ngerti percakapan beberapa menit yang lalu"

  a "M-maaf sebelumnya, hehehe. Aku barusan kurang mengerti apa yang kamu bicarakan"
  p "Ah, gak apa-apa kok"
  a "Namaku Arda, kamu?"

  "Hebat Arda..." 
  "Anda baru saja menanyakan nama seseorang tanpa percakapan basa-basi agar orang itu merasa nyaman untuk menjawabnya..."

  k "Namaku? Nama aku Karina... Karina Halth, senang bisa kenalan sama kamu"

  "Perempuan ini... Dia memberitahu nama lengkapnya tanpa rasa ragu!"

  k "Nama kamu Arda doang?"

  "Entah kenapa intonasi perempuan ini sangat menyebalkan..."

  a "A-ardavelt Donivier"
  k "Uwahhh, kayak nama keluarga kerajaan!"
  a "Sebenarnya memang nama keluarga kerajaan, hanya saja kami lebih memilih untuk hidup sederhana."
  ...
  "Ini semua karena si tua bangka sialan itu yang meninggalkan kami dengan hutang sebesar gunung Krakatau!"
  "Alhasil kami harus membayar hutang-hutangnya dengan harta kami, dan sisa harta yang kami memiliki saat itu hampir mencapai angka 0..."
  "SIALAN KAU TUA BANGKA SIALAN!!!"
  "IKA AKU BISA KEMBALI KE MASA LALU," 
  "AKU AKAN MENJADI BIDAN DISAAT KAU LAHIR, DAN MENEPUK PANTATMU SAMPAI KAU TIDAK BISA MENANGIS SELAMANYA KARENA KEHABISAN AIR MATA!!!"
  ...
  "Ya, memang tidak ada salahnya..."
  "Tapi... kami berdua belum terlalu dekat"
  "Aku tidak ingin menyakitinya, hanya saja..."
  "Aku tidak ingin memiliki banyak teman palsu..."
  "Aku sudah muak dengan itu..."

  a "M-maaf... mungkin tidak untuk sekarang"
  k "A-ah... m-maaf..."
  a "Tidak apa-apa"
  k "Seharusnya aku tidak asal mengajakmu berteman..."
  k "Seharusnya aku dan kamu harus saling mengetahui satu sama lain sebelum berteman..."
  a "Y-ya..."
  k "Seharusnya aku tidak mengajakmu untuk bercakap..."
  k "Aku tidak tahu jika kau sebenarnya ingin bercakap atau tidak..."

  "Tunggu sebentar, aku tidak bermaksud--"

  k "Seharusnya aku sadar, betapa tidak tahu dirinya aku..."
  k "Kenapa aku selalu melakukan hal bodoh... kenapa..."
  k "Seharusnya aku memikirkan perasaan orang lain dibandingkan dengan perasaanku sendiri..."
  a "Anu..."
  k "..."
  a "Apa yang kau ucapkan itu salah besar. Kau harus memikirkan perasaanmu sendiri, baru kau pikirkan perasaan orang lain"
  a "Jika orang tersebut tidak menyukaimu, maka orang itu bukanlah orang yang tepat. Kau boleh merasa bersalah atas tindakanmu, tapi kau tidak boleh membawa perasaan bersalahmu itu hingga kau menghancurkan dirimu sendiri"
  a "Seperti kata-kata yang kau ucapkan sebelumnya, itu sangat menyakitkan"
  a "Kau memutuskan untuk berbincang dengan diriku dan aku menerimanya"
  a "Kau memutuskan untuk menanyai seputar diriku dan aku menerimanya"
  a "Kau memutuskan untuk berteman denganku dan aku menolaknya"
  a "Tapi apakah itu sebuah akhir? Menurutku bukan"
  a "Karena seperti yang kau dengar sebelumnya? Aku hanya ingin berteman dengan orang yang benar-benar aku kenal"
  k "Tapi kamu gak ngomong begitu"
  a "Eh?"

  "EHHHHHHHHHH!!!!!"
  "SIAL! KUKIRA AKU SUDAH MENGUTARAKAN PERASAANKU!"
  "TERNYATA ITU HANYA ADA DIPIKIRANKU!"
  "SIALANNNNN!!!"
  "Padahal aku sudah menceramahinya panjang lebar seperti orang yang berwawasan sangat luas tentang kehidupan..."

  a "Y-ya... jika kau memang benar-benar ingin berteman denganku..."
  a "Bagaimana jika kita bertukar kontak?"
  a "Jadi kita bisa saling berbincang lebih dalam tentang diri kita masing-masing, ya kan? Kan, kan, kan?"
  k "..."
  ...
  k "Boleh, mungkin itu keputusan yang lebih baik"

  "Hahhhhhhhhhhh..... syukurlah kalau begitu"
  "Tapi ini tetap memalukan!"
  "Bertukar kontak dengan perempuan secantik ini?!"
  "Seharusnya aku sadar diri!"
  "Tak lama aku mengambil hpku di saku celanaku dan memperlihatkan nomor HP-ku padanya"
  "Karina mulai memasukan nomorku ke kontaknya"
  "Ahhh..." 
  "Seorang perempuan cantik menambahkan nomorku di kontaknya..."
  "Aku sangat bahagia"
  "Saking bahagianya aku ingin membantai para lolicon di dunia ini"
  "Dingdingding"
  "Pesan masuk dari Karina"
  ...
  "Situasi ini cukup canggung..."

  k "Jadi, biasanya kamu ngapain aja kalau lagi senggang? Dari sudut pandang anak kerajaan"
  a "Tentu saja seperti kebanyakan orang, berbaring di kasur, bermain HP, memainkan gameku yang ada di HP"
  ...
  a "Karina... gak semua keluarga kerajaan bisa liburan semewah itu. Terakhir kali kami liburan semewah itu saat aku masih bayi, dan itu juga kami pergi ke tempat ayahnya kakekku, bukan ke tempat yang kami dambakan..."
  k "Ohhh..."
  ...
  "Kami tertawa terbahak-bahak"
  "Aku tidak tahu kenapa kami berdua tertawa" 
  "Mungkinkah karena lemotnya diriku, atau karena aku memang sangat lucu di matanya"
  "Yang aku tahu hanyalah, aku dan dia tertawa"
  "Aku bahkan tidak peduli apa yang membuat dia tertawa"
  "Tapi rasanya melihat dia tertawa seperti ini membuatku sangat senang"
  "Tapi aku apresiasi dia"
  "Dia bisa dengan mudah merubah moodnya dengan cepat"
  "Padahal beberapa menit yang lalu dia terlihat sangat..."
  "Depresif?"
  "Dengan apa yang ia ucapkan setelah aku menolak pertemananya"
  "Hanya inilah yang bisa kulakukan"
  "Mungkin ada baiknya aku melanjutkan obrolan ini, agar dia bisa terus tersenyum"
...
label bad_end2:
  a "Aku sebenarnya pengen bertanya dari tadi..."

  "Padahal aku baru ingin bertanya sekarang"

  a "Sebenarnya tujuan kamu ke Ciruka itu untuk apa?"
  k "Aku pergi ke Ciruka buat sekolah di sana kok. Di sana aku tinggal bersama nenekku! Dia sangat baik, kadang-kadang dia memberikan aku sangat banyak uang jajanr!"
  a "Ohh! Bagus dong kalau begitu!"
  k "Iya, hehehe"

  "Hohhh... pindah sekolah ternyata"
  
  a "Ke--"

  "Hampir saja, aku hampir menanyakan kenapa dia pindah sekolah"
  "Mungkin saja ada masalah di sekolahnya, jadi lebih baik aku hindari percakapan seperti itu"

  a "Oh iya. Barusan kmau bilang mau sekolah di sini, tepatnya sekolah mana?"
  k "SMAN 1 Ciruka"
  a "SMAN apa?"
  k "SMAN 1 Ciruka"
  ...
  k "Tapi... apa kamu yakin ingin berteman denganku..."

  "Siii--ALLLLL!!!"
  "Aku lupa aku awalnya tidak ingin berteman dengannya"

  a "M-mungkin sekarang kita adalah teman... hehe..."
  k "Apa kamu yakin ingin berteman denganku...?"

  "ARGHHHHH!!!"
  "Jika dia memperlihatkan wajah memelas seperti itu, aku jadi tidak bisa menolaknya"

  a "Y-ya, tentu saja!"
  k "Kamu yakin, yakin?"
  a "Aku yakin, yakin!"
  k "Yakin, yakin, yakin, yakin?"
  a "Yakin, yakin, yakin, yakin!"
  k "Yakin, yakin, yakin yakin, yakin, yakin?"
  a "Yakin, yakin, yakin, yakin, yakin, yakin!"
  k "Yakin, yakin, yakin, yakin, yakin, yakin, yakin, yakin?"
  a "Yakin, yakin, yakin, yakin, yakin, yakin, yakin, yakin!"

  "Kenapa aku jadi begini..."

  k "KALAU BEGITU, KAMU ADALAH TEMAN PERTAMAKU SEKARANG! SELAMAT!"
  ...
  "Sebenarnya aku ingin bertanya tentang kehidupannya"
  "Hanya saja, ini bukanlah waktu dan tempat yang tepat"
  "Teman pertama ya..."

  k "Artinya kita juga teman sekelas dong?!"
  a "Ya enggak juga, kan belum dibagikan kelasnya"
  k "Dibagikan?"
  ...
  a "Jadi di sekolah kita, satu angkatan akan dibagi dari kelas 12-A sampai 12-F"
  a "Di mana pembagian itu akan berdasarkan dari hasil rapor siswa dari kelas sebelumnya, yaitu kelas 11, begitu..."
  k "Ohhh, kayaknya aku bakal masuk kelas F..."
  a "Pasti"
  k "..."
  a "Karena siswa maupun siswi baru juga akan dimasukkan ke kelas F. Aku gak ngerti kenapa akan otomatis masuk kelas F tanpa pertimbangan dahulu..."
  k "Bagus dong!"
  a "Eh-- Menurutku metodenya kurang bagus sih, tapi masuk akal juga. Mungkin maksud dari metodenya itu untuk menghargai para pelajar yang sudah lama dan akan naik ke kelas yang lebih tinggi dengan hasil yang ia raih. Jadi para pelajar baru gak bisa asal masuk dan menggantikan pelajar lama yang sudah berusaha"
  k "Ohhh, bisa jadi, bisa jadi"
  k "Tapi gimana nasib pelajar baru yang sama-sama sudah berusaha dengan keras tapi karena suatu kejadian, dia harus pindah sekolah dan masuk ke kelas paling bawah?"
  a "Nahhh... itu--"
  k "Hm?"
  ...
  k "Selamat Tuan Arda! Selamat! Dan saya mohon maaf atas ketelatan untuk memberimu ucapan selamat"

  "Huh? Kenapa dia memberikan aku ucapan selamat"

  a "Terima kasih Nyonya! Terima kasih! Tapi, apa yang telah saya menangkan jika saya berkenan untuk bertanya akan perihal ini?"
  ...
  "Bagaimana dengan--"
  "Ah...lebih baik aku tidak memikirkannya..."
  "Aku hanya akan menjawabnya tanpa memikirkan hal itu..."
  ...
  "Aku mulai mengenakan tas ranselku dan memasukkan HP-ku kesaku"
  "Aku berdiri dan menunggu Karina mengemas barangnya agar kita bisa keluar bersama"
  ...
  "Ternyata sudah cukup malam, pasti Ayah, Ibu dan Harris sedang menungguku di rumah"
  "Aku tak sabar untuk memainkan PS3 bersama Harris sepanjang hari"

  a "!"

  "Tiba-tiba ada orang yang menyentuh bahuku dari belakang"
  ...
  k "Entah berapa lama momen ini akan berakhir, aku sudah bahagia dengan apa yang kulakukan sama kamu... Arda..."

  "..."

  k "M-maaf, rasanya kurang pantas jika aku berkata seperti itu... harusnya aku lebih tahu diri, maaf"
  a "G-gak, gak apa-apa kok. Aku juga senang bisa jalan bareng sama teman baru. Sensasi baru yang jarang aku rasain, apalagi malam kayak gini, dingin"
  k "Kamu suka rasa dingin?"
  a "Iya, habisnya nyaman. Kalau panas aku mudah berkeringat, hehehe"
  ...
  k "E-eh, enggak, aku barusan ngomong tanpa pikir!"
  a "Kekurangan makanan mengakibatkan kekurangan energi yang membuat kerja otak tidak maksimal. ARTINYA KAMU HARUS MAKAN DI RUMAHKU! BIAR OTAKMU BERKERJA MAKSIMAL!"

  "Aku sendiri tidak tidak tahu omong kosong apa yang aku ucapkan," 
  "tapi aku merasa sangat pintar setelah mengucapkan hal itu" 
  "hehehe..."
  ...
  "Aku menuruti perintahnya"
  "Aku sendiri kasihan jika dia terlalu malu untuk menanggapi apa yang aku katakan walaupun hanya sebuah candaan"
  "Hembusan angin malam melewati selah-selah rambutku, hembusan yang kurasakan ini sangat nyaman, karena aku sangat menyukai udara dingin"
  "Mataku menoleh kearah Karina..."
  "Hembusan angin ini tidak hanya melewati selah-selah rambutku, tapi juga melewati rambutnya Karina"
  "Rambut kuning keemasannya yang berterbangan..."
  "Apa yang kulihat ini bagaikan 7 keajaiban dunia"
  "Kecantikannya melepaskan dingin dari hari malam yang kurasakan"
  "Bagaimana bisa keluarganya punya masalah?"
  "Apa mereka tidak tahu jika mereka punya seorang malaikat yang harus dijaga?"
  "Di saat aku melihat kedepan, ternyata beberapa langkah lagi aku sampai di rumahku"
  ...
  "Aku melakukan ini karena aku peduli terhadapnya" 
  "Aku tidak bisa membiarkan seorang malaikat berjalan sendirian di malam hari"
  "Yaaa... walaupun aku pernah meninggalkan dia di stasiun, karena aku pikir kita tidak memiliki arah yang sama"
  ...
  u "Kak Arda, sudah ada di dalam rumah belum?"
  a "Belum, emangnya ada apa?"
  u "Ya sudah, kamu masuk dulu. Pasti capek karena perjalanankan"
  a "Oh, iya iya"
  b "Ya sudah, bibi matiin ya teleponnya. Dah..."
  ...
  "Aku kira siapa, ternyata bibiku. Seharusnya aku simpan nomor mereka..."
  "Hahhh... bodoh amat. Aku sangat capek hari ini, seakan-akan jiwaku disedot oleh tukang sedot wc"
  "Tak lama aku menelepon Harris"
  "Tuuuttt... Tuuuttt... Tuuuttt..."
  "Tuuuttt... Tuuuttt... Tuuuttt..."
  "Tuuuttt... Tuuuttt... Tuuuttt..."
  ...
  m "Harris, tumben belum tidur"
  h "Eh, Pak Michael. Iya, barusan Ibu suruh aku buat jaga rumah. Katanya Kak Arda mau pulang malam in-- Hoammm..."
  m "Hohhh... mereka pasti jalan-jalan lagi..."
  a "Iya..."
  m "Hahhh... kebiasaan emang. Masa muda mereka belum larut ternyata, hahaha! Saya jadi iri"
  m "Ya sudah kalau begitu, kalian istirahat sekarang ya. Jangan begadang, awas kalau sampai begadang"
  ...
  "Ayahnya Lara pun pulang ke rumahnya, rumahnya tepat di sebelah rumahku"
  "Jadi jika ada apa-apa, aku cukup pergi ke rumah sebelahku"
  "Hidup memang cukup menenangkan jika ada seseorang yang selalu terbuka untukmu"
  "Aku memasuki rumahku dengan muka yang sedikit masam, karena Harris yang lama membuka pintu"
  ...
  a "H-huh?"
  b "B-bibi tahu, ini benar-benar mengejutkan... Bibi hanya ingin kau tahu agar tidak terlalu memikirkannya di esok hari..."
  b "Besok adalah hari kalian masuk sekolah yang pertama... jadi Bibi ingin kalian untuk tetap berada di rumah"
  ...
  b "Akupun tidak tahu! Hiks..."
  b "Yang aku tahu mereka sedang dalam kondisi yang sangat amat kritis..."
  ...
  "Aku menaruh tanganku di dada..."
  "Aku mengepalkanku tanganku pada dadaku dengan kuat..."
  "Aku harus menanyakannya..."
  "Aku harus..."
...
label bad_end3:
  a "Gak... harghhh..."
  a "Aku... butuh... bantu--harghhh"
  b "BIBI SEGERA TELEPON DARURAT!"

  "Dengan cepat Bibi mematikan panggilannya"
  "Mungkin saat ini dia sedang menelepon ambulan"
  "Atau sesuatu yang ‘darurat’"

  a "Harg--ahhh"

  "Tahan Arda... Tahan..."
  "Aku menaruh kedua lenganku di lantai untuk menopang badanku yang hampir terjatuh ke lantai"
  "Tahan..."
  "Taaa--hannnn..."
  "..."
  "....."
  ".........."
  "Aku terjatuh"
  "Mukaku mendarat tepat diatas lantai, disusul dengan seluruh badanku"
  "Aku terkapar di atas lantai"
  ...
  "Mungkin aku bisa menyusul Ayah dan Ibu..."
  "Tempat di mana mereka berada"
  "Akan menjadi tempat di mana aku akan berada..."
  "..."
  "....."
  ".........."
  "Harris?"
  "Harris?!"
  "HARRISSS?!"
  "AKU MELUPAKAN ADIKKU?!"

  a "HARRISSSSS!!!"
  d "Tenang nak, adikmu berada di rumah"
  d "Salah satu temanku menemaninya hanya untuk malam ini"
  a "Malam? Malam ini?!"
  d "Ya, hanya untuk malam ini"
  a "Jam berapa sekarang?!"
  d "Sekarang? Sebentar biar saya am--"
  s "Sekarang jam 01:41"

  "Sudah berapa lama aku berada di sini?"

  s "Kurang lebih sekitar 4 jam"

  "Sial..."
  "Sialan..."
  "Bagaimana aku bisa sampai disini"

  s "Anda mengalami serangan panik yang menyebabkan pernafasan anda terganggu secara total, yang menga--"
  d "Shhh"
  s "..."
  d "Nak, seperti yang dijelaskan oleh suster tadi. Kau terkena serangan panik"
  d "Aku ingin kau beristirahat di sini hanya untuk malam ini, suster ini akan mengawasimu"
  a "Tapi aku harus--"
  d "Aku tahu, kau ingin tetap bersama adikmu. Tapi malam ini kau harus istirahat dengan cukup"
  d "Aku tidak ingin kau mengalami gejala yang lebih parah, apakah nak Arda bisa mengerti"
  a "Y-ya"
  d "Bagus"
  d "Oh iya, cobalah jangan terlalu mengencangkan suara di ruangan sebelah ada orang yang sakit"
  d "Dadah..."

  "Dokter itu meninggalkan ruangan, tempat aku dirawat"

  s "N--"
  a "?"
  s "N-nak... Arda? Perlu sesuatu...?"
  a "Aku perlu waktu sendirian..."
  s "Eh-- apa kau yakin? Aku bisa mendengar keluhanmu kok"
  a "Yakin, jadi kumohon..."
  s "Ba--iklah... ada tombol untuk memanggilku diatas meja sebelahmu jika kamu perlu sesuatu, mengerti?"
  a "Ya"
  s "Baik kalau begitu, dadah..."
  a "..."

  "Begitupula dengan suster, dia telah meninggalkan ruangan ini"
  "Aku membaringkan diriku di kasur, lagi"
  "Aku berbaring di atas kasur, kepalaku penuh dengan pikiran buruk"
  ...
  "Jeritan tangisku aku sembunyikan dalam bantalku..."
  "Hanya ruangan inap ini yang bisa melihat betapa menyedihkannya aku sekarang"
  "Orang yang menangis ini tidak memiliki tempat awal untuk memulai"
  "Dia sudah berada di tengah-tengah"
  "Dia tidak tahu harus mulai darimana"
  "Dia hanya bisa menangis"
